...
`cihadacar/taskhub` (this file is the index).
...
|---|-------|--------|-----------|
| [#1](https://github.com/cihadacar/taskhub/issues/1) | Project setup | session, setup | — |
| [#2](https://github.com/cihadacar/taskhub/issues/2) | REST + Security | session, rest-security | #1 |
| [#3](https://github.com/cihadacar/taskhub/issues/3) | gRPC notifications | session, grpc | #2 |
| [#4](https://github.com/cihadacar/taskhub/issues/4) | Database (JPA+Flyway) | session, database | #2 |
| [#5](https://github.com/cihadacar/taskhub/issues/5) | Test strategy | session, testing | #2, #3, #4 |
| [#6](https://github.com/cihadacar/taskhub/issues/6) | Docker & CI/CD | session, ci-cd | #5 |
| [#7](https://github.com/cihadacar/taskhub/issues/7) | K8s & GitOps | session, kubernetes | #6 |
| [#8](https://github.com/cihadacar/taskhub/issues/8) | Observability | session, observability | #7 |
