...
| Setting | Value                                                   |
|---------|---------------------------------------------------------|
| Group | `io.github.cihadacar.taskhub`                           |
| Base package | `io.github.cihadacar.taskhub`                        |
| Java | 25                                                      |
| Spring Boot | 4.1.x                                                   |
...
```
taskhub-api/src/main/java/io/github/cihadacar/taskhub/
...
notification-service/src/main/java/io/github/cihadacar/taskhub/notification/
